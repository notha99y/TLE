...
def readTLE(tle):
    ...
    for i in range(df.shape[0]):
        if i%2 == 0:
            ...
            temp.append({**dic1,**dic2,**dic3,**dic4,**dic5,**dic6,**dic7,**dic8,**dic9,**dic10,**dic11,**dic12})
...
def main():
    ...
    plotTLE('sat41169.txt',True,False)
    plotTLE('sat39227.txt')
